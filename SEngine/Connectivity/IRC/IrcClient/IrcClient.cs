...
namespace Meebey.SmartIrc4net
{
	...
	public class IrcClient : IrcCommands
	{
		...
		public bool ActiveChannelSyncing
		{
			...
			{
#if DEBUG
				Console.WriteLine("Active channel syncing: " + value);
#endif
		...
		public bool PassiveChannelSyncing
		{
			...
			{
#if DEBUG
				Console.WriteLine("Passive channel syncing: " + value);
#endif
		...
		public bool AutoJoinOnInvite
		{
			...
			{
#if DEBUG
				Console.WriteLine("AutoJoinOnInvite: " + value);
#endif
		...
		public bool AutoRejoin
		{
			...
			{
#if DEBUG
				Console.WriteLine("AutoRejoin: " + value);
#endif
				_AutoRejoin = value;
			}
		}
		...
		public bool AutoRejoinOnKick
		{
			...
			{
#if DEBUG
				Console.WriteLine("AutoRejoinOnKick: " + value);
#endif
		...
		public bool AutoRelogin
		{
			...
			{
#if DEBUG
				Console.WriteLine("AutoRelogin: " + value);
#endif
				_AutoRelogin = value;
			}
		}
		...
		public bool AutoNickHandling
		{
			...
			{
#if DEBUG
				Console.WriteLine("AutoNickHandling: " + value);
#endif
...
#if DEBUG
				Console.WriteLine("SupportNonRfc: " + value);
#endif
		...
		{
#if DEBUG
			Console.WriteLine("IrcClient created");
#endif
		...
		~IrcClient()
		{
			Console.WriteLine("IrcClient destroyed");
		}
#endif
...
#if DEBUG
			Console.WriteLine("IrcMessageData " +
								"nick: '" + data.Nick + "' " +
								"ident: '" + data.Ident + "' " +
								"host: '" + data.Host + "' " +
		...
		{
#if DEBUG
			Console.WriteLine("Storing channels for rejoin...");
#endif
		...
		{
#if DEBUG
			Console.WriteLine("Rejoining channels...");
#endif
...
#if DEBUG
			Console.WriteLine("Mr. Proper action, cleaning good...");
#endif
		...
		private ReceiveType _GetMessageType(string rawline)
		{
			...
			if (found.Success)
			{
				...
				{
#if DEBUG
					Console.WriteLine("This IRC server (" + Address + ") doesn't conform to the RFC 2812! ignoring unrecognized replycode '" + replycode + "'");
#endif
				...
				switch (replycode)
				{
					...
					default:
						...
						{
#if DEBUG
							Console.WriteLine("replycode unknown (" + code + "): \"" + rawline + "\"");
#endif
							return ReceiveType.Unknown;
						}
				}
...
#if DEBUG
			Console.WriteLine("messagetype unknown: \"" + rawline + "\"");
#endif
			return ReceiveType.Unknown;
		}
						...
						if (add)
						{
							if (ActiveChannelSyncing)
							{
								...
								if (GetChannelUser(ircdata.Channel, temp) != null)
								{
...
#if DEBUG
										Console.WriteLine("added op: " + temp + " to: " + ircdata.Channel);
#endif
									}
									catch (ArgumentException)
									{
#if DEBUG
										Console.WriteLine("duplicate op: " + temp + " in: " + ircdata.Channel + " not added");
#endif
									}
									...
									cuser.IsOp = true;
#if DEBUG
									Console.WriteLine("set op status: " + temp + " for: " + ircdata.Channel);
#endif
								}
								else
								{
#if DEBUG
									Console.WriteLine("_InterpretChannelMode(): GetChannelUser(" + ircdata.Channel + "," + temp + ") returned null! Ignoring...");
#endif
								}
							}
...
#if DEBUG
									Console.WriteLine("removed op: " + temp + " from: " + ircdata.Channel);
#endif
									// update the user op status
									ChannelUser cuser = GetChannelUser(ircdata.Channel, temp);
									cuser.IsOp = false;
#if DEBUG
									Console.WriteLine("unset op status: " + temp + " for: " + ircdata.Channel);
#endif
								}
								else
								{
							...
							if (add)
							{
								if (ActiveChannelSyncing)
								{
									...
									if (GetChannelUser(ircdata.Channel, temp) != null)
									{
...
#if DEBUG
											Console.WriteLine("added halfop: " + temp + " to: " + ircdata.Channel);
#endif
										}
										catch (ArgumentException)
										{
#if DEBUG
											Console.WriteLine("duplicate halfop: " + temp + " in: " + ircdata.Channel + " not added");
#endif
										}
										...
										cuser.IsHalfop = true;
#if DEBUG
										Console.WriteLine("set halfop status: " + temp + " for: " + ircdata.Channel);
#endif
									}
									else
									{
...
#if DEBUG
										Console.WriteLine("removed halfop: " + temp + " from: " + ircdata.Channel);
#endif
										// update the user halfop status
										NonRfcChannelUser cuser = (NonRfcChannelUser)GetChannelUser(ircdata.Channel, temp);
										cuser.IsHalfop = false;
#if DEBUG
										Console.WriteLine("unset halfop status: " + temp + " for: " + ircdata.Channel);
#endif
									}
									else
									{
						...
						if (add)
						{
							if (ActiveChannelSyncing)
							{
								...
								if (GetChannelUser(ircdata.Channel, temp) != null)
								{
...
#if DEBUG
										Console.WriteLine("added voice: " + temp + " to: " + ircdata.Channel);
#endif
									}
									catch (ArgumentException)
									{
#if DEBUG
										Console.WriteLine("duplicate voice: " + temp + " in: " + ircdata.Channel + " not added");
#endif
									}
									...
									cuser.IsVoice = true;
#if DEBUG
									Console.WriteLine("set voice status: " + temp + " for: " + ircdata.Channel);
#endif
								}
								else
								{
...
#if DEBUG
									Console.WriteLine("removed voice: " + temp + " from: " + ircdata.Channel);
#endif
									// update the user voice status
									ChannelUser cuser = GetChannelUser(ircdata.Channel, temp);
									cuser.IsVoice = false;
#if DEBUG
									Console.WriteLine("unset voice status: " + temp + " for: " + ircdata.Channel);
#endif
								}
								else
								{
...
#if DEBUG
									Console.WriteLine("added ban: " + temp + " to: " + ircdata.Channel);
#endif
								}
								catch (ArgumentException)
								{
#if DEBUG
									Console.WriteLine("duplicate ban: " + temp + " in: " + ircdata.Channel + " not added");
#endif
								}
							}
							if (OnBan != null)
...
#if DEBUG
								Console.WriteLine("removed ban: " + temp + " from: " + ircdata.Channel);
#endif
							}
							if (OnUnban != null)
							{
					...
					case 'l':
...
#if DEBUG
									Console.WriteLine("stored user limit for: " + ircdata.Channel);
#endif
								}
								catch (FormatException)
								{
#if DEBUG
									Console.WriteLine("could not parse user limit: " + temp + " channel: " + ircdata.Channel);
#endif
								}
							}
						}
						if (remove)
						{
							if (ActiveChannelSyncing)
							{
								channel.UserLimit = 0;
#if DEBUG
								Console.WriteLine("removed user limit for: " + ircdata.Channel);
#endif
							}
						}
						break;
					case 'k':
						...
						if (add)
						{
							if (ActiveChannelSyncing)
							{
								channel.Key = temp;
#if DEBUG
								Console.WriteLine("stored channel key for: " + ircdata.Channel);
#endif
							}
						}
						if (remove)
						{
							if (ActiveChannelSyncing)
							{
								channel.Key = "";
#if DEBUG
								Console.WriteLine("removed channel key for: " + ircdata.Channel);
#endif
							}
						}
						break;
						...
						if (add)
						{
							if (ActiveChannelSyncing)
							{
								if (channel.Mode.IndexOf(mode[i]) == -1)
								{
									channel.Mode += mode[i];
#if DEBUG
									Console.WriteLine("added channel mode (" + mode[i] + ") for: " + ircdata.Channel);
#endif
								}
							}
						}
...
#if DEBUG
								Console.WriteLine("removed channel mode (" + mode[i] + ") for: " + ircdata.Channel);
#endif
							}
						}
						break;
...
#if DEBUG
			Console.WriteLine("received ERROR from IRC server");
#endif
...
#if DEBUG
				Console.WriteLine(who + " joins channel: " + channelname);
#endif
		...
		private void _Event_PART(IrcMessageData ircdata)
		{
			...
			if (ActiveChannelSyncing)
			{
				...
				{
#if DEBUG
					Console.WriteLine("parting channel: " + channel);
#endif
				...
				{
#if DEBUG
					Console.WriteLine(who + " parts channel: " + channel);
#endif
		...
		private void _Event_QUIT(IrcMessageData ircdata)
		{
			...
			if (ActiveChannelSyncing)
			{
				...
				if (user != null)
				{
					...
					{
						Console.WriteLine("user.JoinedChannels (for: '" + who + "') returned null in _Event_QUIT! Ignoring...");
#endif
					}
#if DEBUG
				}
				...
				{
					Console.WriteLine("GetIrcUser(" + who + ") returned null in _Event_QUIT! Ignoring...");
#endif
				}
			}
...
#if DEBUG
				Console.WriteLine("stored topic for channel: " + channel);
#endif
			}
...
#if DEBUG
					Console.WriteLine("updated nickname of: " + oldnickname + " to: " + newnickname);
#endif
...
#if DEBUG
				Console.WriteLine("stored empty topic for channel: " + channel);
#endif
			}
		...
		private void _Event_RPL_NAMREPLY(IrcMessageData ircdata)
		{
				...
				IsJoined(channelname))
			{
				...
				foreach (string user in userlist)
				{
					...
					{
#if DEBUG
						Console.WriteLine("creating IrcUser: " + nickname + " because he doesn't exist yet");
#endif
					...
					{
#if DEBUG
						Console.WriteLine("creating ChannelUser: " + nickname + " for Channel: " + channelname + " because he doesn't exist yet");
#endif
...
#if DEBUG
							Console.WriteLine("added op: " + nickname + " to: " + channelname);
#endif
						}
...
#if DEBUG
							Console.WriteLine("added halfop: " + nickname + " to: " + channelname);
#endif
						}
						if (voice)
						{
...
#if DEBUG
							Console.WriteLine("added voice: " + nickname + " to: " + channelname);
#endif
						}
					}
		...
		*/
		...
		private void _Event_RPL_ENDOFNAMES(IrcMessageData ircdata)
		{
			...
			{
#if DEBUG
				Console.WriteLine("passive synced: " + channelname);
#endif
		...
		private void _Event_RPL_AWAY(IrcMessageData ircdata)
		{
			...
			if (ActiveChannelSyncing)
			{
				...
				{
#if DEBUG
					Console.WriteLine("setting away flag for user: " + who);
#endif
					ircuser.IsAway = true;
				}
			}
		...
		private void _Event_RPL_WHOREPLY(IrcMessageData ircdata)
		{
				...
				IsJoined(channel))
			{
				...
				if (ircuser == null)
				{
					Console.WriteLine("GetIrcUser(" + nick + ") returned null in _Event_WHOREPLY! Ignoring...");
				}
#endif
				...
				if (channeluser == null)
				{
					Console.WriteLine("GetChannelUser(" + nick + ") returned null in _Event_WHOREPLY! Ignoring...");
				}
#endif
				...
				{
#if DEBUG
					Console.WriteLine("updating userinfo (from whoreply) for user: " + nick + " channel: " + channel);
#endif
...
#if DEBUG
				Console.WriteLine("active synced: " + channelname +
		...
		{
#if DEBUG
			Console.WriteLine("nickname collision detected, changing nickname");
#endif
			if (!AutoNickHandling)
			{
				return;
