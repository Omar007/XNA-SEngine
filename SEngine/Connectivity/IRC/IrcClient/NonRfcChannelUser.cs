 ...
 * $URL: svn+ssh://svn.qnetp.net/svn/smartirc/SmartIrc4net/trunk/src/IrcClient/NonRfcChannelUser.cs $
 * $Rev: 274 $
 * $Author: meebey $
...
namespace Meebey.SmartIrc4net
{
	...
	public class NonRfcChannelUser : ChannelUser
	{
		...
		~NonRfcChannelUser()
		{
			Console.WriteLine("NonRfcChannelUser (" + Channel + ":" + IrcUser.Nick + ") destroyed");
		}
#endif
